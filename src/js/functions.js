...
const generateStartEnd = (matrix, shipLength, lengths, startDir = randomStartDir(lengths, shipLength)) =>
  getHighAbsoluteCoord(startDir.dir) === 0 ? [point(0, 0, 0), point(0, 0, 0)] : checkInBetween(...[startDir.start, lineEndPoint(startDir.start, shipLength, startDir.dir)], matrix, checkIfShipCell) ? generateStartEnd(matrix, shipLength, lengths) : [startDir.start, lineEndPoint(startDir.start, shipLength, startDir.dir)]
